...
export async function POST(req) {
  try {
    ...
    await db.runTransaction(async (tx) => {
      ...
      const resolution = resolveCdt(snap.data(), monto);
      if (resolution.changed) tx.update(ref, buildUpdate("cdt", resolution));
    });
